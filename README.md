...
1- FunctionGraph: Serverless services that trigger functions based on events or HTTP request
2- APIG: API REST to host the APIs and configuring the verb (GET, PUT, POST, DELETE), endpoints, parameters, headers and bandwidth or the request.
